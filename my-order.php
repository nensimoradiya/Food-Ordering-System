                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-5 col-md-5 col-lg-3">
                                    <div class="sidebar clearfix m-b-20">
                                        <div class="main-block" style="margin-top: 10%;max-height: calc(100vh - 1rem);overflow-y: auto;">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                                                    <div class="entry-logo">
                                                        <a class="img-fluid"
                                                            href="track-order-details.php?orderid=<?php echo $row['Ordernumber']; ?>"><img
                                                                src="images/order.jpg" width="100" height="100"
                                                                alt="Order "></a>
                                                    </div>
                                                    <!-- end:Logo -->
                                                    <div class="entry-dscr">
                                                        <h5><a
                                                                href="track-order-details.php?orderid=<?php echo $row['Ordernumber']; ?>">Order
                                                                #
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                                    <div class="right-content bg-white">
                                                        <div class="right-review">
                                                            ...
                                                            <a href="track-order-details.php?orderid=<?php echo $row['Ordernumber']; ?>"
